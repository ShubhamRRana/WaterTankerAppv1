...
interface MenuItem {
  ...
  route: 'Bookings' | 'Drivers' | 'Vehicles' | 'Reports' | 'Profile';
  onPress: () => void;
}
...
interface AdminMenuDrawerProps {
  visible: boolean;
  onClose: () => void;
  onNavigate: (route: 'Bookings' | 'Drivers' | 'Vehicles' | 'Reports' | 'Profile') => void;
  onLogout: () => void;
  currentRoute?: 'Bookings' | 'Drivers' | 'Vehicles' | 'Reports' | 'Profile';
}
