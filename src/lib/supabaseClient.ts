...
// Get Supabase URL and publishable key from environment variables
...
if (!supabaseUrl || !supabasePublishableKey) {
  const errorMessage =
    'Missing Supabase configuration. Please set EXPO_PUBLIC_SUPABASE_URL and EXPO_PUBLIC_SUPABASE_PUBLISHABLE_KEY in your .env file, app.config.js, or EAS build secrets.';
